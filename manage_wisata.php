...
<head>
    <title>Manage Wisata Details - MarkPro</title>
    <meta charset="utf-8">
                ...
                <div class="item-big-report col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div style="padding-left: 30px;" class="thumbnail-box col-md-4">
                            ...
                            <img class="thumbnail-wisata" src="images/img_wisata.png" alt="">
                        </div>
                            ...
                            <form method="POST" action="includes/data_model.php">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label
                                                class="title-input-type-primary-tiketsaya for=exampleInputPassword1">Harga
                                                Tiket ($US)</label>
                                        ...
                                        <div class="col-md-6">
                                            <label
                                                class="title-input-type-primary-tiketsaya for=exampleInputPassword1">Tanggal
                                                Wisata</label>
                                            <input name="data_wisata" value="<?php echo $checkdata_wisata_details['data_wisata']; ?>" type="text" class="form-control input-type-primary-tiketsaya"
                                ...
                                <div class="form-group" style="margin-top: -20px;">
                                    ...
                                    <textarea name="ketentuan" class="form-control input-type-primary-tiketsaya"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="short_desc" class="form-control input-type-primary-tiketsaya"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label
                                                class="title-input-type-primary-tiketsaya for=exampleInputPassword1">has
                                                Wifi?</label>
                                            <input name="is_wifi" value="<?php echo $checkdata_wisata_details['is_wifi']; ?>" type="text" class="form-control input-type-primary-tiketsaya"
                                                id="exampleInputPassword1" placeholder="No">
                                        </div>
                                        <div class="col-md-4">
                                            <label
                                                class="title-input-type-primary-tiketsaya for=exampleInputPassword1">has
