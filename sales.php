        ...
        <div class="row report-group">
            ...
            <div class="col-md-12">
                <div class="item-big-report col-md-12">
                    <table class="table table-tiketsaya table-borderless">
                        <thead>
                            <tr>
						...
						foreach($checkdata_sales as $data_sales_final => $data_print_sales) {
                            ...
                            //data place
                            $path_place = 'MyTickets/'.$print_data_user_profile['username'].'/wisata';
                            $checkdata_place = $database->getReference($path_place)->getValue();
					...
					?>
                            ...
                            <tr>
                                <td scope="row user-table-item">
                                    <img class=" user-table-item" src="images/user_1.png" alt="">
                                </td>
