<?php
	...
	//data turis
	$path_turis = 'Users';
	$checkdata_turis = $database->getReference($path_turis)->getValue();
...
<head>
	<title>Dashboard - Admin MarkPro</title>
	<meta charset="utf-8">
		...
		<div class="row report-group">
			...
			<div class="col-md-6">
				<div class="item-big-report col-md-12">
					...
					<div class="user-item">
						...
						<a href="user_details.php" class="btn btn-small-border btn-primary">View Profile</a>
					</div>
						<?php } ?>
			...
			<div class="col-md-6">
				<div class="item-big-report col-md-12">
					...
					<p class="sub-title-tiket">
						USER JUST BOUGHT TICKET
					</p>
					<a href="#" class="btn btn-small btn-primary btn-primary-tiketsaya">See More</a>
					<div class="divider-line"> </div>
